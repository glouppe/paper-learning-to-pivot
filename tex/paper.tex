...
% In high energy physics, systematic uncertainties have traditionally been
% taken into account using... \glnote{search for related works.}
% In the context of likelihood-free inference, the proposed approach ... \glnote{todo}
% Finally, from the point of view

% In the literature, this problem is known
% under many names, including transfer learning, co-variate shift or domain
% adaptation. It has traditionally been  solved either by re-weighting approaches
% (see e.g.
% \citep{shimodaira2000improving,gretton2009covariate,sugiyama2012machine,vapnik2013constructive}
% and references therein) or by learning robust representations over domains
...
% Both of these families of methods assume that source and target distributions
% share a same representation space, either of overlapping supports in the case of
% re-weighting methods or as a domain-invariant low rank manifold in the case of
% robust embedding methods.
