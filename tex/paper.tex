...
for which we require the uniform prior $p(z)$ (for $z$ in ${\cal Z}$). Importantly,
classification of $Y$ with respect to $X$ is therefore assumed in the context
where $Z$ is marginalized out. Results
