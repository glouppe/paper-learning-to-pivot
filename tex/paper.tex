...
uncertainties \glnote{Shouldnt we define what are statistical uncertainties, so
that systematic uncertainties are in constrast better understood?}, but also
...
training~\citep{goodfellow2014generative}, which aims to build a classifier
