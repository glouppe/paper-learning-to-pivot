...
Systematic uncertainties in high energy physics, representing our incomplete
knowledge in the simulation of physical processes or in the detection apparatus,
may cause variations in the conditional distributions of features used for
training a classifier.  As such, the efficacy of a classifier may change under
the variations caused by systematic uncertainties.  In this paper, we repurpose
adversarial training as a means to produce a pivotal classifier which is
invariant to variations of the nuisance parameters which parameterize the
effects of systematic uncertainties. In the machine learning context, this
problem is closely related to those of domain adaptation and enforcing fairness
in classification. Following that line of work, the method proposed in this work
can be regarded as generalization that also supports the continuous case,
which can be viewed as handling infinitely many domains or as enforcing fairness
