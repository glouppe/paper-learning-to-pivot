...
By contrast, when running Algorithm~\ref{alg:adversarial-training} as initialized
with the classifier obtained previously, and in combination with a mixture density
network $r$ (modeling $Z|f(X;\theta_f)$ as a truncated mixture of four gaussian
...
\glnote{Discuss practical considerations regarding the stability of training.}
\glnote{Warn against
