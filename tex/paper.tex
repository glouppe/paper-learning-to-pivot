...
sufficiently small steps, then $f$ should eventually
converge to a classifier that is both
optimal and pivotal. Provided this classifier exists, the adversarial term ${\cal L}_r$
can therefore be regarded as a way to select among
