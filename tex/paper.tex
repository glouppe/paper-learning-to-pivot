...
case. Finally, by construction, we assume the uniform prior $p(z)$ over the
...
\begin{itemize}
   ...
   Z}$ since we assume a uniform prior by construction. Note that in the continuous case, the supremum of the differential entropy
   over continuous distributions of the same bounded support is also realized by the uniform distribution over that support.
\end{itemize}
