...
(AMS), when uncertainties in the background are taken into account (see Eqn.~19
...
To minimize the effects of the nuisance $Z$ in the background events, we train a
...
\begin{figure}
    ...
    \vspace{-1cm}
    \caption{Approximate median signifance as a function of the decision threshold
