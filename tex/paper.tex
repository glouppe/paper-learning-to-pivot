...
\begin{figure}
    ...
    \caption{Toy example. Training curves for ${\cal L}_f(\theta_f)$, ${\cal L}_r(\theta_f, \theta_r)$
             ...
             Adversarial training was performed for $2000$ iterations, mini-batches of size $M=128$, $K=1$ and $\lambda=100$.}
...
Algorithm~\ref{alg:adversarial-training}. In the first $200$ iterations, we
observe that $f$ is worse than random because it rather tries to maximizes the
...
Z}$, as shown by the dashed line in the second plot.
