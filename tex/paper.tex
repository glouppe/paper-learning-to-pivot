...
\begin{figure*}
    ...
    $f$ against a continuous parameter $Z$, assuming that $Z|f(X;\theta_f)$
    follows a truncated gaussian distribution.}
...
negative log-likelihood of $Y|X$ under $f$ and of of $Z|f(X;\theta_f)$ under
$r$:
\begin{align}
...
pivotal, e.g. as in \citep{ganin2014unsupervised}, but this is in fact not necessary.
