...
\begin{figure*}
    \begin{center}
        \includegraphics[width=0.23\textwidth]{figures/f-plain.pdf}
        \includegraphics[width=0.23\textwidth]{figures/surface-plain.pdf}
        \includegraphics[width=0.23\textwidth]{figures/f-adversary.pdf}
        \includegraphics[width=0.23\textwidth]{figures/surface-adversary.pdf}
    \end{center}
    \vspace{-0.5cm}
    \caption{Toy example.
