...
may not be optimal, as discussed in Section~\ref{sec:theory}, but that can be
...
estimates of the nuisance are used as inputs to $f4$?}

In machine learning, the proposed method can be related to the problem of domain
adaptation
...
\citep{EdwardsS15} is certainly among the closest to our work, in which fairness
is enforced through an adversarial minimax setup composed of a classifier and an
adversary discriminator. In particular, our work can be regarded as a
