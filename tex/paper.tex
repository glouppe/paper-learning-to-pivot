...
case. Finally, the  proposition below is derived in a non-parametric setting, by
...
Accordingly, the
value function $E$ can be restated as $$E'(\theta_f) = {\cal
...
Interestingly, let us emphasize that these results hold using only the (1D) output $s$
