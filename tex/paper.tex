...
\theta_f)$ is generated from the nuisance value $z$. Intuitively, if $p(f(X;
...
parameter. Setting $\lambda$ to a large value will preferrably enforces $f$ to
...
build and evaluate. In particular, calibrating their decision fucntion, i.e.
