...
\end{align}
The nuisance parameter $Z$ represents in this case our
...
generating training data $\{ x_i, y_i, z_i \}_{i=1}^N$, from which we train
a classifier $f$ minimizing $L_f(\theta_f)$ without any adversary.
