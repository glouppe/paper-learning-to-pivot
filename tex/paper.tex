...
the hyperparameter $\lambda$ of Eqtn.~\ref{eqn:vf-lambda} with respect to
...
When we include systematic uncertainties we will need to balance the
...
classification accuracy and robustness that ultimately maximizes the
