...
We assume training data $\{x_i, y_i, z_i\}_{i=1}^N$. Let us assume that prior to incorporating the effect of uncertainty
...
imposed with respect to the $p(X|Z)$ with $Y$ is marginalized out. In some situations
...
with a sufficiently flexible  parametric distribution $p_{\theta_r}(z | f(X;\theta_f)=s)$. 
The adversary $r$ may
