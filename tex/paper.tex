...
invariant to variations of the nuisance parameters describing the
...
statistical analysis of data (see e.g., \citep{bohm2010introduction,cowan2011asymptotic}).  Nuisance parameter often,
