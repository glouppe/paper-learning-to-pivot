...
the collision \citep{butterworth2008jet,baldi2016jet}. Critically, this
...
In this setting, we reuse the classification problem of \citep{baldi2016jet}
...
on the high-level features data described in \citep{baldi2016jet}, on a subset
of 150000 samples for training while AMS is evaluated on an independent test set of 5000000
samples. Results reported below are averages over 5 runs.
