...
\glnote{We should make it clearer what {\it classification optimality} means: it
is with respect to $Y|X=x$  when  $x$ results from $z\sim p_Z, x \sim X_z$.
This is often strictly different from optimality with respect to $Y|X=x,Z=z$ for the true value $z$.}
