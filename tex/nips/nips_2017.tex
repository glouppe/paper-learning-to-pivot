...
with the nuisance parameters (see e.g., \citep{degroot1986probability}). Pivotal quantities are e.g. fundamental to the construction
...
\begin{minipage}{.46\linewidth}
    \centering
        \includegraphics[width=0.95\textwidth]{../figures/training.pdf}
...
\begin{minipage}{.46\linewidth}
    \centering
        \includegraphics[width=0.95\textwidth]{../figures/ams.pdf}
