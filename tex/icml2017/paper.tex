...
based on adversarial networks for enforcing the pivotal property, i.e., the stastistical independence of a predictive
model with respect to nuisance parameters. We derive theoretical results showing that the proposed algorithm tends
