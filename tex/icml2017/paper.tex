...
model. We derive theoretical results showing that the proposed algorithm tends
...
for which one can tune the trade-off between power and robustness. Finally, we
