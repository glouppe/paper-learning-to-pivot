...
\icmltitlerunning{Learning to Pivot with Adversarial Networks}

\begin{document}

\twocolumn[
\icmltitle{Learning to Pivot with Adversarial Networks}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the icml2016
% package.
\icmlauthor{Gilles Louppe}{g.louppe@nyu.edu}
\icmladdress{New York University}
\icmlauthor{Michael Kagan}{makagan@slac.stanford.edu}
\icmladdress{SLAC National Accelerator Laboratory}
\icmlauthor{Kyle Cranmer}{kyle.cranmer@nyu.edu}
\icmladdress{New York University}
...
based on adversarial networks for enforcing the pivotal property on a predictive model, i.e., its independence
with respect to nuisance parameters. We derive theoretical results showing that the proposed algorithm tends
...
for which one can tune a trade-off between power and robustness. Finally, we
...
robustness of inference and the performance metrics used to evaluate a
...
continuous.
In this broader context, statisticians have for long been working on the development of robust inference techniques
based on the concept of a pivot -- a quantity whose distribution is invariant
with the nuisance parameters. Pivotal quantities are e.g. fundamental to the construction
